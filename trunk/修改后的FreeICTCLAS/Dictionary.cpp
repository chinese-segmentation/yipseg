 ...
 *  Func Name  : DelItem
 *
 *  Description: Delete a word item from the dictionary
 *              
 *
 *  Parameters : sWord: the word
 *               nHandle:the handle number
...
/*********************************************************************
 *
 *  Func Name  : DelMdoified()
 *
 *  Description: clear the modify table
 *              
 *
 *  Returns    : success or fail
 *********************************************************************/
 ...
 *  Func Name  : IsExist()
 *
 *  Description: Judge the word is exit or not in orignaltable or modifytable
 *              
 *
 *  Parameters : sWord: the word
 *               nHandle:the handle number
 ...
 *  Func Name  : GetHandle
 *
 *  Description: get the handle and frequency of the word
 *              
 *
 *  Parameters : pnCount: the inner code of the first CHines char
 *               sWord: the word
 *               nHandle:the handle number
 ...
 *
 *  Parameters : sWord:the word
 *               sWordRet:the max match word
 *                nHandle: the only handle which will be attached to the word
 *               
 *
 *  Returns    : success or fail
 *********************************************************************/
 ...
 *              
 *
 *  Parameters : sPOS:the POS string
 *
 *  Returns    : the value
 *********************************************************************/
 ...
 *              
 *
 *  Parameters : nPos:the part of speech
 *               sPOSRet:the string of nPOS
 *
 *  Returns    : success or fail
 *********************************************************************/
 ...
 *
 *  Description: get the frenquency of word and handle
 *              
 *
 *  Parameters : sWord:the word
 *               nHandle:the handle of the word
 *               
 *  Returns    : success or fail
 *********************************************************************/
...
/*********************************************************************
 *
 *  Func Name  : OutpuyChars
 *
 *  Description: input the content of dictionary into a file
 *              
 *
 *  Parameters : sFilename:the name of the file
 *               
 *  Returns    : success or fail
 *********************************************************************/
 ...
 *  Func Name  : Merge
 *
 *  Description: Merge a new dictionary into a present one
 *              
 *
 *  Parameters : dict2:a new dictionary
 *               nRatio:the ratio of the two dictionary
 *               
 *
 *  Returns    : success or fail
 *********************************************************************/
 ...
 *  Func Name  : Optimum
 *
 *  Description: Optimum the m_indexTable
 *              
 *
 *  Returns    : success or fail
 *********************************************************************/
